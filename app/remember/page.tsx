      ...
      <main className="main-content-scroll">
        <div className="remember-page-wrapper">
          <div className="remember-grid">
            {[
              { category: 'stickers', img: '/images/Remember/Stickers/Rmember Amit 31.jpeg', label: 'עמית מסביב לעולם' },
              { category: 'memorial', img: '/images/Remember/memorial/Rmember Amit 9.jpeg', label: 'פינות הנצחה' },
              { category: 'shows', img: '/images/Remember/shows/Rmember Amit 59.jpeg', label: 'הופעות' },
              { category: 'journey', img: '/images/Remember/journey/Rmember Amit 14.jpeg', label: 'מסעות' },
