...
import './BraverySection.css';

export default function BraverySection() {
  return (
    <section id="bravery" className="bravery-section">
      <div className="bravery-container">
        <div className="bravery-image-col">
          ...
          />
          <a
            href="https://www.youtube.com/watch?v=gAIJvP0JXAo"
            target="_blank"
            rel="noopener noreferrer"
            className="bravery-video-btn desktop-only"
          >
            <PlayCircle />
        ...
        <div className="bravery-text-col">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bravery-video-btn mobile-only"
          >
            <PlayCircle />
            <div className="btn-text-content">
              <span className="btn-text-main">מצפן מורשת - חטיבת הנח״ל</span>
