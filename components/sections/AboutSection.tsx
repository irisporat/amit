        ...
        <div className="story-card about-story-card">
          ...
          <div className="story-content">
            <p className="story-first">
              סמ״ר עמית פרידמן ז״ל, בנם של ליאת ואסף פרידמן, נולד באור יהודה בי&quot;א באדר א&apos; תשס&quot;ה (20/02/2005).
            </p>
            ...
            <p>הספורט היה חלק גדול מחייו. שיחק כדורסל בקבוצה העירונית ע.ל.ה אור יהודה, הוא היה שחקן חזק, שתמיד דחף את עצמו ואת חבריו קדימה. בנוסף לכדורסל אהב מאוד כדורגל והיה אוהד נאמן של מועדון הכדורגל ״מכבי תל אביב״.</p>
